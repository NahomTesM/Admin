                              ...
                              >
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-[9px] font-bold text-slate-400 uppercase">Primary: {t.primarySubject}</p>
                                  </div>
                                </div>
                            ...
                            {teachers.length > 0 ? teachers.map(t => (
                              ...
                              >
                                ...
                                <div className="overflow-hidden">
                                  ...
                                  <p className="text-[8px] font-bold text-slate-400 uppercase truncate">{t.primarySubject}</p>
                                </div>
                              </button>
                            )) : (
                                  ...
                                  {teachers.map(t => (
                                    ...
                                    >
                                      ...
                                      <div className="overflow-hidden">
                                        ...
                                        <p className="text-[9px] font-bold text-slate-400 uppercase truncate">Primary: {t.primarySubject}</p>
                                      </div>
                                    </button>
                                  ))}
                               </div>
